/**
 * The 22 scheduled languages of India (Eighth Schedule) + English. English and
 * Hindi ship fully translated; the rest select cleanly and fall back to English
 * (labelled). `dir` drives RTL for Urdu / Kashmiri / Sindhi.
 */
