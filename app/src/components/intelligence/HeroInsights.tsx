    ...
    <section className="mx-auto max-w-[1440px] px-10 pt-10">
      <div className="mb-5 flex items-baseline justify-between">
        ...
        <button className="inline-flex cursor-pointer items-center gap-2 rounded-full border border-line bg-transparent px-3 py-[7px] text-[12.5px] text-ink hover:border-line-dark">
          ...
          <svg width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="#7E8590" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round">
      ...
      <div className="grid grid-cols-2 gap-5">
        ...
        <article className="relative overflow-hidden rounded-xl border border-line bg-surface px-8 py-7">
          <div
            ...
            style={{ background: "radial-gradient(circle at top right, #C15A1512, transparent 70%)" }}
          />
          <div className="mb-[18px] flex items-center gap-2.5">
            <span
              className="flex h-8 w-8 items-center justify-center rounded-lg"
              style={{ background: "#C15A1518", color: "#C15A15" }}
            >
              <TrendUpIcon />
            </span>
            <span>
              <span className="block text-xs font-medium uppercase tracking-[0.06em] text-accent">
          ...
          <div className="mb-[18px] rounded-lg border border-line bg-panel px-4 py-3.5">
            <div className="mb-1.5 text-[11.5px] text-muted">{FORECAST_HERO.actionsLabel}</div>
        ...
        <article className="relative overflow-hidden rounded-xl border border-line bg-surface px-8 py-7">
          <div
            className="pointer-events-none absolute right-0 top-0 h-[220px] w-[220px]"
            style={{ background: "radial-gradient(circle at top right, #12325B12, transparent 70%)" }}
          />
          <div className="mb-[18px] flex items-center gap-2.5">
            <span
              className="flex h-8 w-8 items-center justify-center rounded-lg"
              style={{ background: "#12325B18", color: "#12325B" }}
            >
              <RupeeIcon />
            </span>
            <span>
            ...
            {BUDGET_HERO.moves.map((m, i) => (
              ...
              >
                ...
                <span className="flex-1">
                  ...
                  <span className="mt-0.5 block text-[11.5px] text-muted">{m.note}</span>
                </span>
          ...
          <div className="mb-[18px] flex items-center justify-between rounded-lg bg-canvas px-3.5 py-3">
            <div className="text-[12.5px] text-ink">
              <span className="text-muted">{BUDGET_HERO.outcome.label} </span>
