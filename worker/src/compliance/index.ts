import { MPLADS_PERMITTED_SECTORS, MPLADS_PROHIBITED, MPLADS_RULES } from "@saarthi/shared";
import type {
...
/**
 * MPLADS compliance engine (§8.4). Verifies a proposed work against the permitted
 * sectors + prohibited list, and surfaces SC/ST allocation-gap leverage.
 */
